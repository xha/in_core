...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $query = "SELECT nombre_sistema,ruta FROM IS_Core WHERE activo=1 ORDER BY nombre_sistema";
        $sistemas = $connection->createCommand($query)->queryAll();
        
        return $this->render('index', [
            'sistemas' => JSON::encode($sistemas),
        ]);
    }
